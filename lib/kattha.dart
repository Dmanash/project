...
class Kattha extends StatefulWidget{
  @override
  _KatthaState createState() => _KatthaState();
}

class _KatthaState extends State<Kattha> {


  String _katthaResult = '';
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              height:45,
                              width: 200,
                              child:  Text('Calculate in Kattha',
                                style: TextStyle(
                                  fontSize: 20,
                                  color: Colors.white,
                  ...
                  SizedBox(height: 20,),
                  katthaCalculationResult(_katthaResult),
  ...
  Widget katthaCalculationResult(katthaResult){
    bool canShow = false;
    String _katthaResult = katthaResult;



    if (_katthaResult.length > 0 ){
      canShow = true;
    } return Container(
      height: 100,
      width: 250,
      ...
      child: canShow ? Column(
        children: [
          ...
          SizedBox(height: 10,),
          Container(
            child: Text(_katthaResult + ' Kattha',
              style: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.bold
              ),),
  ...
  void handleCalculation(){
    ...
    if (resultDisplayFormKey.currentState.validate()) {
      ...
      _katthaResult = R.toStringAsFixed(2);
